...
% by Christoph Sperber; adjusted by Tamara Keßler (07/2022)
...
stat_threshold = [0.95, 0.99, 0.995, 0.999, 0.9995, 0.9999, 0.99995, 0.99999, 0.999995, 0.999999];
...
%folder = 'D:\Tamara\DisconnectionMaps\Parcel_Disconnection2\renamed'; % this folder contains all relevant disconnection .mat files and NO other .mat files
...
for i_thresh = 1:length(stat_threshold)
    ...
    % and see all matrix cells with signifistcant results.
    ...
    saveloc = 'D:\Tamara\Diskonnektionen\Parcel_Disconnections\all\renamed\GLM_results';
